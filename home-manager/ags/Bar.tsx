...
function KeyboardLayout() {
  ...
  const [icon, setIcon] = createState("unknown");
  hypr.connect("keyboard-layout", (_c, k, layout) => {
    if (k == "beekeeb-piantor" || k == "telink-wireless-gaming-keyboard") {
      setIcon(layout);
    }
  });

  return (
    <box class="KeyboardLayout">
      <label
        class="Layout"
